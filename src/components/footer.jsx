...
import github from "/img/img_reseaux/github.png"
import linkedin from "/img/img_reseaux/linkedin.png"
        ...
        <footer className="bg-black flex justify-center flex-col items-center lg:flex-row lg:justify-around lg:py-[10px]">
            <nav className="flex gap-[40px] my-[20px] lg:m-[0]">
                <Link to="https://github.com/tomfrx12" className="no-underline transition-transform duration-300 ease-in-out transform hover:scale-120">
                    <img className="max-h-[1.5rem] lg:max-h-[2.5rem]" src="/img/img_reseaux/github.png" alt="Logo de Github"/>
                </Link>
                <Link to="https://www.linkedin.com/in/tom-fourneaux-078644332/" className="no-underline transition-transform duration-300 ease-in-out transform hover:scale-120">
                    <img className="max-h-[1.5rem] lg:max-h-[2.5rem]" src="/img/img_reseaux/linkedin.png" alt="Logo de LinkedIn"/>
                </Link>
