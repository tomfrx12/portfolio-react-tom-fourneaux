...
const SeeMore = ({link}) => {
  return (
      <Link to={link} className="group inline-flex items-center gap-2 bg-transparent border-none outline-none transition-transform duration-300 hover:scale-105 w-auto max-w-fit">
