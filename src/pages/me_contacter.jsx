        ...
        <>
            ...
            <div className="flex justify-around text-center lg:mt-[50px]">
                <div className="qrcode">
                    <p>Profil <Link className="underline" to="https://github.com/tomfrx12">Github</Link></p>
                ...
                <div className="qrcode">
                    <p>Profil <Link className="underline" to="https://www.linkedin.com/in/tom-fourneaux-078644332/">LinkedIn</Link></p>
