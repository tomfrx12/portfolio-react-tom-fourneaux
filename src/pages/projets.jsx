        ...
        <>
            ...
            <section className="projets">
                ...
                <CardProjet
                    ...
                    img_illustr="/img/projets/img/E-commerce.png"
                    ...
                    img_link="/img/logo_des_projets/figma-logo.webp"
                    alt_link="Logo Figma"
                />

                <CardProjet 
                    className_img="m-[30px] text-center lg:w-[200px]"
                    img_illustr="/img/projets/img/handisup/logo-handisup.png"
                    ...
                    img_link="/img/projets/img/handisup/logo-handisup-noir-et-blanc.png"
                ...
                <CardProjet
                    ...
                    img_illustr="/img/projets/img/logo-vertical.png"
                    ...
                    img_link="/svg/home.svg"
                />

                <CardProjet
                    id_project="projet-clubecosaintsever"
                    className_img="m-[30px] max-w-full max-h-max text-center"
                    img_illustr="/img/projets/img/alternative bannière.png"
                    ...
                    title_link=""
                    img_link="/svg/magnifying_glass.svg"
                    alt_link=""
                ...
                <CardProjet 
                    className_img="m-[30px] max-w-full max-h-max text-center"
                    img_illustr="/img/projets/img/maquette/maquette.png"
                    ...
                    img_link="/svg/github.svg"
                />

                <CardProjet 
                    className_img="m-[30px] max-w-full max-h-max text-center"
                    img_illustr="/img/projets/img/bannière.png" 
                ...
                <CardProjet 
                    ...
                    img_illustr="/img/projets/img/interview/Fiches.png"
                ...
                <CardProjet 
                    className_img="m-[30px] max-w-full max-h-max text-center"
                    img_illustr="/img/projets/img/banniere.png"
