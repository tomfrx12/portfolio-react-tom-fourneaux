...
function Charte_Graphique() {
    return (
        <>
                <h1 className="text-center m-[20px] py-[10] px-[20] bg-black text-base lg:self-center lg:text-3xl">Charte Graphique</h1>
                ...
                <section className="section3">
                    ...
                    <div className="interdit">
                        ...
                        <div className="flex flex-col gap-[25px] lg:grid lg:grid-cols-2 lg:grid-rows-2 lg:justify-items-center lg:m-[20px]">
                            <div className="flex justify-around bg-white mb-[0px] m-[20px] p-[20px] rounded-[20px] shadow-[5px_5px_5px_var(--color-grey)] transition:transform duration:300 hover:-translate-y-2 lg:gap-[20px]">
                            ...
                            <div className="flex justify-around bg-white mb-[0px] m-[20px] p-[20px] rounded-[20px] shadow-[5px_5px_5px_var(--color-grey)] transition:transform duration:300 hover:-translate-y-2 lg:gap-[20px]">
                                ...
                                <img className="max-w-[100px] max-h-[100px] lg:max-w-[200px]" src={supp_logo} alt="Supprimer une partie du logo"/>
                            </div>
                        </div>
                ...
                <div className="flex flex-col gap-[20px] m-[40px_50px_0px_50px] py-[10px] px-[20px] lg:flex-row lg:justify-center">
                    <Link to="../assets/img/charte_graphique/Charte-Graphique-Tom-Fourneaux.pdf" download className="flex justify-center self-center">Télécharger ma <br/>charte graphique</Link>
                    <Link to="../img/charte_graphique/Maquette Figma Portfolio.zip" download className="flex justify-center self-center">Télécharger ma <br/>maquette</Link>
                </div>
        </>
    );
}
