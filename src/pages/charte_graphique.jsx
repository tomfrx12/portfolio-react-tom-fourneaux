    ...
    return (
        <>
            ...
            <div className="flex flex-col gap-[20px] m-[40px_50px_0px_50px] py-[10px] px-[20px] lg:flex-row lg:justify-center">
                <a href="../assets/img/charte_graphique/Charte-Graphique-Tom-Fourneaux.pdf" download className="flex justify-center self-center">Télécharger ma <br/>charte graphique</a>
                <a href="../img/charte_graphique/Maquette Figma Portfolio.zip" download className="flex justify-center self-center">Télécharger ma <br/>maquette</a>
            </div>
        </>
    );
}
